# PURPOSE: Self Testing Viz - Global Planning Meeting
# AUTHOR: K Srikanth | SI
# LICENSE: MIT
# DATE: 2021-11-05
# NOTES: adapted from groundhog_day/Scripts/FY21Q3_Review_SelfTesting-Trends.R
...
ggsave("Graphics/hts_self_v1.svg", width = 3.3, height = 3.7, units = "in", dpi = 300)
...
ggsave("Graphics/hts_self_v2_male.svg", width = 3.3, height = 2, units = "in", dpi = 300)
...
ggsave("Graphics/hts_self_v2_kp.svg", width = 3.3, height = 2, units = "in", dpi = 300)
...
viz_offset <- df_growth %>% 
  ...
  scale_color_identity() +
  si_style_ygrid() +
  labs(x = NULL, y = NULL, title = "Self-testing made up only 10% of USAID HIV testing in FY21Q3") +
  theme(strip.text = element_text(family = "Source Sans Pro SemiBold"))

ggsave("Graphics/hts_self_vs_test.svg", width = 3.3, height = 3.7, units = "in", dpi = 300)
