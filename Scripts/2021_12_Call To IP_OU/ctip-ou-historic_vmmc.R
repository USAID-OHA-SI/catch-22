...
# PURPOSE:  Call to IP/OU - VMMC trends
# LICENSE:  MIT
# DATE:     2021-11-09
# UPDATED: 2021-12-07
# NOTE: adapted from catch-22/Scripts/2021115_Global Planning Meeting/gpm_historic_vmmc.R
...
si_save("Graphics/ctip-ou-historic-vmmc.svg",
        height = 4.25)  
