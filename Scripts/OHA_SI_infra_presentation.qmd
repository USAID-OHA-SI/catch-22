...
[![](https://user-images.githubusercontent.com/5873344/232764503-ff2c980d-8de1-4572-993d-d111e43b54e9.png){fig-align="left" width="1000"}](https://drive.google.com/file/d/1WNTQ-tiGpR6k1ZxgN2BwXMRWnABgF45B/view?usp=share_link)
...
Our mission is to create an inclusive learning/sharing collaborative withing USAID's Office of HIV/AIDS (OHA) where analysts can gain from others' analytic experiences, primarily in and around R. The focus is on how improving our skills collectively so we can develop and foster principles of conducting analysis and viz that will bleed over to the rest of the office.
